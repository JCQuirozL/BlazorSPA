...
namespace APICollection.Migrations.PolicyCollectionMigrations
{
    ...
    [Migration("20220809220923_ChangeTypes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BCWebAPI.Models.PolicyCollection", b =>
                {
            ...
            modelBuilder.Entity("BCWebAPI.Models.PolicyInformationService", b =>
                {
                    b.Property<int>("PolicyInfoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BCWebAPI.Models.PolicyCollection", b =>
                {
                    b.HasOne("BCWebAPI.Models.PolicyCollectionFile", "PolicyCollectionFile")
                        .WithMany()
                        .HasForeignKey("PolicyFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BCWebAPI.Models.PolicyInformationService", "PolicyInformationService")
                        .WithMany()
