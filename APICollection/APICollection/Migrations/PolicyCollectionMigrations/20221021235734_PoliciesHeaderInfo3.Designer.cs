...
namespace APICollection.Migrations.PolicyCollectionMigrations
{
    ...
    [Migration("20221021235734_PoliciesHeaderInfo3")]
    partial class PoliciesHeaderInfo3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APICollection.Entities.PolicyCollection", b =>
                {
                    ...
                    b.Property<int?>("PolicyHeaderInfoPolicyHeaderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PolicyHeaderInfoPolicyHeaderId");
            ...
            modelBuilder.Entity("APICollection.Entities.PolicyHeaderInfo", b =>
                {
                    b.Property<int>("PolicyHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PolicyHeaderId"), 1L, 1);
                    ...
                    b.HasKey("PolicyHeaderId");

                    b.ToTable("PoliciesHeaderInfo");
                });
            ...
            modelBuilder.Entity("APICollection.Entities.PolicyCollection", b =>
                {
                    ...
                    b.HasOne("APICollection.Entities.PolicyHeaderInfo", null)
                        .WithMany("PoliciesCollection")
                        .HasForeignKey("PolicyHeaderInfoPolicyHeaderId");
            ...
            modelBuilder.Entity("APICollection.Entities.PolicyHeaderInfo", b =>
                {
                    b.Navigation("PoliciesCollection");
                });
