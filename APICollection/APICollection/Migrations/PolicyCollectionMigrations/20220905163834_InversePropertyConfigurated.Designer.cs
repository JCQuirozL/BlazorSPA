...
namespace APICollection.Migrations.PolicyCollectionMigrations
{
    ...
    [Migration("20220905163834_InversePropertyConfigurated")]
    partial class InversePropertyConfigurated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APICollection.Entities.PolicyComment", b =>
                {
                    ...
                    b.Property<int>("PolicyCollectionId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PolicyCollectionId1");
            ...
            modelBuilder.Entity("APICollection.Entities.PolicyComment", b =>
                {
                    b.HasOne("APICollection.Entities.PolicyCollection", "PolicyCollectionId")
                        .WithMany("Comments")
                        .HasForeignKey("PolicyCollectionId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PolicyCollectionId");
                });
